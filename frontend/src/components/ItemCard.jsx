...
const formatDiscount = (discountPercentage) => {
  const value = Number(discountPercentage ?? 0);
...
function ItemCard({ item, onDelete }) {
  return (
    <div className="card">
      ...
      <p><strong>Discount Percentage:</strong> {formatDiscount(item.discountPercentage)}</p>
